...
def adicionar_tarefa():
    ...
    if tarefa and tarefa != "Escreva sua tarefa aqui":
        ...
        messagebox.showwarning("Entrada inválida", "Entre com uma tarefa válida")
...
icon_editar = PhotoImage(file="editar.png").subsample(6, 6)
icon_deletar = PhotoImage(file="deletar.png").subsample(6, 6)

fonte_cabecalho = font.Font(family="Garamond", size=24, weight="bold")
rotulo_cabeçalho = tk.Label(janela, text="Desk Agenda", font=fonte_cabecalho, bg="#f0f0f0", fg="#333").pack(pady=20)
